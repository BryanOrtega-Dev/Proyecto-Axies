<div class="mt-[117px] mb-20 relative">
        ...
        <header>
            <div class="px-[255px]">
                ...
                <div class="flex gap-4 mt-9">
                    <a class="border w-[154px] justify-center py-[14px] rounded-[30px] border-blue-primary flex items-center" href="{{ action([\App\Http\Controllers\NftExploreController::class, 'index']) }}">
    ...
    <svg class="absolute -top-[200px]" width="1920" height="820" viewBox="0 0 1920 820" fill="none" xmlns="http://www.w3.org/2000/svg">
